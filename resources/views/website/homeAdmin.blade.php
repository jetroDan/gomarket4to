...
<div class="content-main">
		...
		<div class="content-top">
			...
			<div class="col-md-8 content-top-2">
				...
				<!--graph-->
		<link rel="stylesheet" href="/assets/cssAdmin/graph.css">
		<!--//graph-->
							<script src="/assets/jsAdmin/jquery.flot.js"></script>
									<script>
		...
		<div class="content-mid">
			...
			<div class="col-md-5">
			  ...
			  <!----Calender -------->
			<link rel="stylesheet" href="/assets/cssAdmin/clndr.css" type="text/css" />
			<script src="/assets/jsAdmin/underscore-min.js" type="text/javascript"></script>
			<script src= "/assets/jsAdmin/moment-2.2.1.js" type="text/javascript"></script>
			<script src="/assets/jsAdmin/clndr.js" type="text/javascript"></script>
			<script src="/assets/jsAdmin/site.js" type="text/javascript"></script>
			<!----End Calender -------->
			</div>
		...
		<div id="owl-demo" class="owl-carousel text-center">
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="/assets/images/imgAdmin/na.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="/assets/images/imgAdmin/na1.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="/assets/images/imgAdmin/na2.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="/assets/images/imgAdmin/na.jpg" alt="name">
			</div>
		...
		<link href="/assets/cssAdmin/owl.carousel.css" rel="stylesheet">
		<script src="/assets/jsAdmin/owl.carousel.js"></script>
			<script>
				$(document).ready(function() {
